...
CREATE TABLE IF NOT EXISTS `fashion`.`Clothing` (
  ...
  PRIMARY KEY (`idClothing`, `name`, `client_idclient`, `client_firstname`, `client_lastname`),
  INDEX `fk_Clothing_client1_idx` (`client_idclient` ASC, `client_firstname` ASC, `client_lastname` ASC) VISIBLE,
  CONSTRAINT `fk_Clothing_client1`
...
CREATE TABLE IF NOT EXISTS `fashion`.`outfits` (
  ...
  `client_firstname` VARCHAR(45) NOT NULL,
  `client_lastname` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idoutfits`, `style`, `client_idclient`, `client_firstname`, `client_lastname`),
  INDEX `style_name_idx` (`style` ASC) VISIBLE,
  INDEX `fk_outfits_client1_idx` (`client_idclient` ASC, `client_firstname` ASC, `client_lastname` ASC) VISIBLE,
